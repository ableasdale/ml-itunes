$(document).ready(function () {
    ...
    new jPlayerPlaylist({
        ...
        {
            title: "<span class='item-artist'>Olafur Arnalds - </span><span class='item-song'>Study for Generative Piano (i)</span><img class='item-image' src='/assets/images/sample-mp3-img.jpg' alt='' />",
            mp3: "/assets/01 Study for Generative Piano (i).mp3"
        }
