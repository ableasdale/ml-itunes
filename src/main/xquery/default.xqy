...
declare function local:show-table() {
	<table class="table table-striped table-bordered">
		{lib-view:create-thead-element(("ID", "Title", "Artist", "Album", "Year", "Size"))}
		<tbody>
			{
				fn:subsequence((for $i in (//iTunes-item) order by fn:number($i/Track-ID) 
				return element tr {
					element td {xs:string($i/Track-ID)},
					element td {xs:string($i/Name)},
					element td {xs:string($i/Artist)},
